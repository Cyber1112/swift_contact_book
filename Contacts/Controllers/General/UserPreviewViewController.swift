...
//  Contacts
//
//  Created by Khakim Zhumagaliyev on 01.10.2022.
//
...
class UserPreviewViewController: UIViewController {
    ...
    func configureConstraints() {
        ...
        let callButtonConstraint = [
            callButton.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            callButton.bottomAnchor.constraint(equalTo: deleteButton.bottomAnchor, constant: -50),
        ...
        NSLayoutConstraint.activate(callButtonConstraint)
    }
